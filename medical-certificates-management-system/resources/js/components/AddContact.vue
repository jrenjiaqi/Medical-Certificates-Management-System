<template>
    <div>
        <div class="container">
            <h2 class="text-center p-2 text-white bg-primary mt-5"> Add Medical Certification </h2>
                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            <label for="name">Name/Rank<span class="red-text">*</span></label>
                            <input type="text" id="name" v-model="contact.name" class="form-control" 
                            placeholder="Enter Name">
                        </div>

                        <div class="form-group">
                            <label for="designation">Designation<span class="red-text">*</span></label>
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="validatedCustomFile">
                                Upload your Medical Certification...
                            </label>
                        </div>
    ...
    methods: {
        saveContact() {
            ...
            if(!this.contact.name) {
                this.errors.push('Name/Rank is required');
            }
            ...
            if(!this.contact.image) {
                this.errors.push('Medical Certification is required');
            }
